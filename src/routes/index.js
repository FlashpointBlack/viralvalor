...
// ------------------------------------------------
console.log('[API_ROUTES_INDEX]: Setting up legacy routes on apiRouter at / ...');
router.use('/', legacyRoutes); // This should ideally not contain /api/conversations if the above works
console.log('[API_ROUTES_INDEX]: Legacy routes setup on apiRouter complete.');
